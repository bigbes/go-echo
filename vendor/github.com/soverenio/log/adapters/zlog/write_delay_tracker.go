...
func getWriteDelayConfig(metrics *logcommon.MetricsHelper,
...
func newWriteDelayPostHook(output io.Writer, fieldName string, preferTrim bool, statReportFn logcommon.DurationReportFunc) *writeDelayPostHook {
