...
import (
	...
	"github.com/soverenio/log/logwriter"
...
func newBackpressureBuffer(output *logwriter.Adapter, bufSize int, extraPenalty uint8, maxParWrites uint8,
...
type internalBackpressureBuffer struct {
	output  *logwriter.Adapter
	missFn  MissedEventFunc
	writeFn func(logcommon.Level, []byte, int64) (int, error)
...
const internalOpLevel = logcommon.Level(255)
...
func (p *internalBackpressureBuffer) LowLatencyWrite(level logcommon.Level, b []byte) (n int, err error) {
	if p.output.IsFatal() {
...
func (p *internalBackpressureBuffer) newQueueEntry(level logcommon.Level, b []byte, startNano int64) bufEntry {
...
func (p *internalBackpressureBuffer) LogLevelWrite(level logcommon.Level, b []byte) (n int, err error) {
	if p.output.IsFatal() {
		return p.output.LogLevelWrite(level, b)
	}
...
func (p *internalBackpressureBuffer) writeFatal(level logcommon.Level, b []byte) (n int, err error) {
...
func (p *internalBackpressureBuffer) bypassWrite(level logcommon.Level, b []byte, startNano int64) (int, error) {
...
func (p *internalBackpressureBuffer) checkWrite(level logcommon.Level, b []byte, startNano int64) (int, error) {
...
func (p *internalBackpressureBuffer) fairQueueWrite(level logcommon.Level, b []byte, startNano int64) (int, error) {
...
func (p *internalBackpressureBuffer) flushWrite(level logcommon.Level, b []byte, startNano int64) (int, error) {
...
func (p *internalBackpressureBuffer) queueWrite(level logcommon.Level, b []byte, startName int64) (int, error) {
	p.buffer <- p.newQueueEntry(level, b, startName)
	return len(b), nil
}

func (p *internalBackpressureBuffer) directWrite(level logcommon.Level, b []byte, startNano int64) (int, error) {
...
func (p *internalBackpressureBuffer) flushTillMark(level logcommon.Level, b []byte, startNano int64) (int, error) {
...
func (p *internalBackpressureBuffer) flushTillDepletion(level logcommon.Level, b []byte, startNano int64) (int, error) {
